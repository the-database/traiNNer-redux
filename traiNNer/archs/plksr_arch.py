...
def repeat_interleave(x, n):  # noqa: ANN201, ANN001
    x = x.unsqueeze(2)
...
class PLKConv2d(nn.Module):
    ...
    def __init__(self, dim, kernel_size, with_idt) -> None:  # noqa: ANN001
        super().__init__()
...
class RectSparsePLKConv2d(nn.Module):
    ...
    def __init__(self, dim, kernel_size) -> None:  # noqa: ANN001
        super().__init__()
        self.idx = dim
        m = kernel_size
        n = kernel_size // 3
...
class SparsePLKConv2d(nn.Module):
    ...
    def __init__(
        self,
        dim,  # noqa: ANN001
        max_kernel_size,  # noqa: ANN001
        sub_kernel_sizes,  # noqa: ANN001
        dilations,  # noqa: ANN001
        use_max_kernel,  # noqa: ANN001
        with_idt,  # noqa: ANN001
    ) -> None:
        super().__init__()
    ...
    @staticmethod
    def _calc_rep_kernel_size(ks, dilation):  # noqa: ANN205, ANN001
        return (ks - 1) * dilation + 1

    @staticmethod
    def _get_origin_kernel(kernel, dilation=1, p=0):  # noqa: ANN205, ANN001
        I = torch.ones((1, 1, 1, 1)).to(kernel.device)  # noqa: N806
    ...
    @staticmethod
    def _dwc_to_dense(kernel):  # noqa: ANN205, ANN001
